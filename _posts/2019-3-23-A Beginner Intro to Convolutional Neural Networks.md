...
different types of filters to detect different features

Filter/kernel with different sizes
...
Left:before relu applied.,Right:after ReLU applied
Pooling layer:
...
Max pooling on Relu feature map
Accepts a volume of size W1×H1×D1
...
Image result for convolutional neural network
look at the classification part where you can see fully connected layer.
