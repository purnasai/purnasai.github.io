...
In this tutorial, we’ll cover how to implement the neural-style algorithm that’s based on this paper called A Neural Algorithm of Artistic Style developed by Leon A. Gatys, Alexander S. Ecker and Matthias Bethge.

for code chekout this repository or this blog
...
Content and style reconstructions using CNN. Figure from Gatys, Ecker, and Bethge, “A Neural Algorithm of Artistic Style”, arXiv, 2015
...
credit to cs231n: Visualizing and Understanding
...
style loss function at one layer l
...
Official Pytorch Neural transfer tutorial here.

Most of the blog here is reproduced from the Other Interesting blog here. I dont think i can explain more than this.
